...
<body>
    ...
    <div class="container mt-3">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <ul class="nav tab-menu mb-4">
                <li class="nav-item"><a href="home-dosen.php" class="nav-link active">Home</a></li>
        ...
        <a href="list-pengumuman-dosen.html" class="btn btn-outline-secondary more-btn">Selengkapnya...</a>
    </div>
