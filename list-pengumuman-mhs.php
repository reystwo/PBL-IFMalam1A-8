    ...
    <div class="container mt-3">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <ul class="nav tab-menu mb-3">
                <li class="nav-item"><a href="home-mahasiswa.php" class="nav-link">Home</a></li>
                <li class="nav-item"><a href="list-pengumuman-mhs.php" class="nav-link active">Pengumuman</a></li>
                <li class="nav-item"><a href="#" class="nav-link">Profile</a></li>
            </ul>
            <div class="input-group mb-3" style="max-width: 300px;">
                <input type="text" id="searchInput" class="form-control" placeholder="Cari Pengumuman...">
                <button onclick="cariPengumuman()" class="btn btn-primary">Cari</button>
            </div>
        </div>
        ...
        <div class="row g-4">
            <div class="col-md-3">
                ...
                <div class="card announcement-card">
                    <img src="information.jpg" class="placeholder-img" alt="Pengumuman">
                    <div class="card-body">
                        <h5 class="card-title">Judul Pengumuman 5</h5>
                        <p class="card-text">Ini adalah contoh isi pengumuman yang dapat digunakan sebagai acuan...</p>
                        <p class="text-muted"><small>Dosen | dd/mm/yyyy</small></p>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                ...
                <div class="card announcement-card">
                    <img src="information.jpg" class="placeholder-img" alt="Pengumuman">
                    <div class="card-body">
                        <h5 class="card-title">Judul Pengumuman 6</h5>
                        <p class="card-text">Ini adalah contoh isi pengumuman yang dapat digunakan sebagai acuan...</p>
                        <p class="text-muted"><small>Dosen | dd/mm/yyyy</small></p>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                ...
                <div class="card announcement-card">
                    <img src="information.jpg" class="placeholder-img" alt="Pengumuman">
                    <div class="card-body">
                        <h5 class="card-title">Judul Pengumuman 7</h5>
                        <p class="card-text">Ini adalah contoh isi pengumuman yang dapat digunakan sebagai acuan...</p>
                        <p class="text-muted"><small>Dosen | dd/mm/yyyy</small></p>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                ...
                <div class="card announcement-card">
                    <img src="information.jpg" class="placeholder-img" alt="Pengumuman">
                    <div class="card-body">
                        <h5 class="card-title">Judul Pengumuman 8</h5>
                        <p class="card-text">Ini adalah contoh isi pengumuman yang dapat digunakan sebagai acuan...</p>
                        <p class="text-muted"><small>Dosen | dd/mm/yyyy</small></p>
                    </div>
                </div>
